...
use druid::text::TextStorage as DruidTextStorage;
use super::storage::TextStorage;

use druid::{ArcStr, Command, Data, Env, FontDescriptor, KeyOrValue, UpdateCtx};
...
impl DruidTextStorage for RichText {

    fn add_attributes(&self, mut builder: PietTextLayoutBuilder, env: &Env) -> PietTextLayoutBuilder {
