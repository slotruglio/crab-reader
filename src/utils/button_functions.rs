use druid::EventCtx;
use crate::{components::book::{BookReading, BookManagement, Book}, utils::saveload};

/// Activate or deactivate editing mode
/// return the new value of is_editing
/// and the new value of attribute text
pub fn edit_button(ctx: &mut EventCtx, book: &mut Book, text: String, is_editing: bool) -> (bool, String) {
...
pub fn change_page(ctx: &mut EventCtx, book: &mut Book, is_editing: bool, single_view: bool, next: bool) {
    if !is_editing {
        ...
        saveload::save_page_of_chapter(
            ...
            book.get_current_page_number()).unwrap();
        ctx.request_paint();
